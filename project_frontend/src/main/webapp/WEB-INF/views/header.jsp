...
<title>Fab Furniture</title>
  <link rel="icon" href="resources/images/sidelogo.png"  sizes="50x50">
<link rel="stylesheet"
	...
	<nav class="navbar navbar-inverse <!--navbar-fixed-top  -->">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				<c:url value="/resources/images/sidelogo.png" var="url5"></c:url>
				<a class="navbar-brand" href="${url1 }"><img src="${url5 }" alt="ganesh"
			...
			<div class="collapse navbar-collapse" id="collapse-example">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="${url1 }">FAB FURNITURE</a></li>
					...
					<c:url value="/measurement" var="url3"></c:url>
					<li><a href="${url3 }">Measurements chart</a></li>
					<c:url value="/customize" var="url2"></c:url>
					<li><a href="${url2 }">Customize</a></li>
				</ul>
			</div>
		</div>
	</nav>
